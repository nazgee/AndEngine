 ...
 * to provide synchronized access to your <code>CircularFifoBuffer</code>:
 * 
 * <pre>
...
public class CircularFifoBuffer extends BoundedFifoBuffer {
	...
	/**
	 * Constructor that creates a buffer from the specified collection. The
	 * collection size also sets the buffer size
	 * 
	 * @param coll
